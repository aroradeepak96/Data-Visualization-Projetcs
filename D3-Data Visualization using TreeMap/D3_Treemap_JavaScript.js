if (parent.document.getElementsByTagName("iframe")[0]){
	parent.document.getElementByTagName("iframe")[0].setAttribute('style','height: 800px !important');
}
...
function display(d) {
	...
	.attr("class",function (d){
		...
		if ((d.dy > 75 && d.dy<=100)&& (d.dx>75 && d.dx<=100)|| 
				...
				(d.dy>75 && (d.dx>75 && d.dx<=100))) { return "textdiv_m";}
		if (d.dy>100 && d.dx>100 || d.dy<100 && d.dx>100 || d.dy >100 && d.dx<100 ){ return "textdiv";}
	});
	...
	function transition(d){ 
		...
		g2.append("foreignObject")
			...
			.attr("class","foreignobj")
			.append("xhtml:div")
			.html(function(d){ if(d.children) {return d.name;}
			});
